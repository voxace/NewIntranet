...
router.get('/indonesian', (req, res) => {renderDoc(req,res,'1es_SU8gVtgoJRY6mkjvOPIsreQGBWxdyjcXQOa8uyAU')})
router.get('/technology', (req, res) => {renderDoc(req,res,'1k8tBT6qI1KG0fwA-JhuRtMvkI0qBc8BKDNABMR-81kA')})
router.get('/music', (req, res) => {renderDoc(req,res,'1X_15Me6UAKnC_fSiPtg_NOCDfke-lnb6toIsrULTcek')})
router.get('/art', (req, res) => {renderDoc(req,res,'1DYWhKmxLiXyO4PG8c7bho4Lf43TnhXItyks5jPz5N7o')})
